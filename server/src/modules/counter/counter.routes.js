...
import { createCounter, getAllCounters, updateCounterStatus, deleteCounter } from './counter.controller.js';
...
router.delete("/:id", requireAuth, requireRole(USER_ROLES.ADMIN), deleteCounter);
